        ...
        <CardHeader>
          ...
          <CardDescription>
            {admin
              ...
              : "Your current assignments and notification state in the new backend."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-glass/50 p-4 rounded-xl border border-glass-border">
              <div className="text-3xl font-bold text-primary">{summary.unreadNotifications}</div>
              <div className="text-sm font-medium text-muted-foreground mt-1">Unread notifications</div>
            </div>
            <div className="bg-glass/50 p-4 rounded-xl border border-glass-border">
      ...
      <Card className="glass-card col-span-1">
        ...
        <CardContent>
          <div className="flex flex-col gap-3">
            {[
              { href: "/notifications", title: "Notifications", desc: "Read and manage app-native notifications." },
