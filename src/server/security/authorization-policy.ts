...
const PAGE_GUARDS: Array<PermissionRequirement & { prefix: string }> = [
  ...
  { prefix: "/settings/people", resource: "settings.users", minLevel: "VIEW" },
  { prefix: "/settings/general/motd", resource: "settings.announcements", minLevel: "MANAGE" },
  { prefix: "/settings/general/feedback", resource: "settings.feedback", minLevel: "MANAGE" },
