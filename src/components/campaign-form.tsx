...
const campaignFormSchema = z.object({
  ...
  logoType: z.enum(['url', 'custom'], { error: "Please select a logo type."}),
  logoUrl: z.string().optional().or(z.literal('')),
  logoInitials: z.string().max(2, { error: "Initials can be max 2 characters."}).optional(),
  logoBgColor: z.string().regex(/^#[0-9a-fA-F]{6}$/, { error: "Color must be a valid hex code (e.g., #RRGGBB)"}).optional().or(z.literal('')),
