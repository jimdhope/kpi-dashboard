...
export function AgentSidebarLayout({ children, roles = [], currentLayout = null, onLayoutChange, showSidebar = false }: AgentSidebarLayoutProps) {
    ...
    <SidebarProvider defaultOpen={showSidebar}>
      <div className="flex relative z-10 min-h-screen w-full">
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          <header className="sticky top-0 z-10 flex items-center justify-end h-14 px-4 border-b bg-background/90 backdrop-blur-sm md:px-6 w-full">
