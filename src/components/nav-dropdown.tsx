...
// Navigation Context for managing dropdown state across all dropdowns
...
// Provider component to wrap navigation items
...
export function NavDropdown({ items, trigger, href, align = 'left', className, onClick, dropdownKey }: NavDropdownProps) {
  // Use href as default key if dropdownKey not provided
  ...
  return (
    ...
    >
      ...
      >
        <div className={cn(
          "glass-dropdown rounded-xl p-2 shadow-xl border border-glass-border/40",
