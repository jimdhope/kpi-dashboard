        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    type: "Column",
                    width: "auto",
                    items: [{ type: "TextBlock", text: `${score.totalPoints} pts`, wrap: true, horizontalAlignment: "Right"}]
                }
            ]
        };
    });
...
export const sendTeamsUpdate = async (
    ...
    try {
        ...
        // kpiTableText is no longer markdown, it's generated by generateAgentScoresAdaptiveCardElements
