...
const roleMenuItems = [
  { label: 'Dashboard', href: '/competition-runner', icon: Home },
];

export default function CompetitionRunnerLayout({ children }: RoleLayoutProps) {
          ...
          <Sidebar className="glass-sidebar border-r border-glass-border/40 pt-0 top-[65px] h-[calc(100vh-65px)]">
            <SidebarContent className="pt-4">
              <div className="px-4 mb-4">
                <h3 className="text-sm font-semibold">Competition Runner</h3>
              </div>
              <SidebarMenu>
