...
const CENTRES: Record<string, [number, number]> = {
  ...
  WS: [-2.0, 52.5], WV: [-2.5, 52.5], YO: [-1.5, 54.0], ZE: [-3.5, 58.5],
  YO1: [-0.5, 54.0], YO2: [-1.5, 54.0], YO3: [-1.5, 54.0],
  YO4: [-1.5, 54.0], YO5: [-1.5, 54.0], YO6: [-1.5, 54.0], YO7: [-1.5, 54.0],
  YO8: [-1.5, 54.0], YO9: [-1.5, 54.0], YO10: [-1.0, 53.9], YO11: [-0.4, 54.3],
  YO12: [-0.4, 54.3], YO13: [-0.4, 54.3], YO14: [-0.6, 54.2], YO15: [-0.2, 54.1],
  YO16: [-0.4, 54.3], YO17: [-0.4, 54.3], YO18: [-0.4, 54.3], YO19: [-0.4, 54.3],
  YO21: [-0.6, 54.5], YO22: [-0.6, 54.5], YO23: [-0.6, 54.5], YO24: [-1.1, 53.9],
  YO25: [-0.6, 54.5], YO26: [-1.1, 53.9], YO31: [-1.1, 53.9], YO32: [-1.1, 53.9],
  YO41: [-0.9, 53.9], YO42: [-0.9, 53.9], YO43: [-0.9, 53.9], YO51: [-1.2, 54.0],
  YO60: [-1.2, 54.0], YO61: [-1.2, 54.0], YO62: [-1.2, 54.0], YO71: [-1.0, 54.0],
  YO72: [-1.0, 54.0],
};
...
export async function GET(req: Request) {
  ...
  const searchLocation = geocode(postcode);
